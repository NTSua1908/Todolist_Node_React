import StageDashboardModel from "../models/StageModel/StageDashboardModel";
...
export const users: UserShortModel[] = [
    ...
    },
    {
        ...
        username: "smith",
        avatar: "https://i.pinimg.com/236x/12/37/b3/1237b30268db9ee0c9cbe3a79b1ff8fa.jpg",
    },
    {
...
export const dashboard: StageDashboardModel[] = [
    {
