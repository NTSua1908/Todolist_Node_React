  ...
  return (
    <div className={`shareModal ${theme}`}>
      <div className="shareModal-container">
        <div className="shareModal-title">Add members to the project</div>
        ...
        <div className="shareModal-list">
          <table className="shareModal-table">
            ...
            <tbody>
                  ...
                  {index === editIndex ? (
                    ...
                    <>
                      ...
                      <td className="shareModal-table-actions">
                        ...
                        {deleteIndex === index && isShowDialog && (
                          <Modal
                  ...
                  <>
                    ...
                    <td className="shareModal-table-actions">
                      <button
                        ...
                        disabled={newUser.username.length === 0}
                      >
                        <MdSave title="Save" />
                      </button>
                      <button
              ...
              <tr>
                <td colSpan={4}>
                  {(!isAddingUser || userShared.length !== 0) && (
